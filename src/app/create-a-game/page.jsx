    ...
    <Layout>
      <div className=" flex flex-col items-center mb-10">
        <div className="gap-[12px] text-center mt-5">
          <h1 className="font-fredoka font-[600] gradient-text text-[50px] ">
            Create New Game
          </h1>
          <p className="font-nunito font-[400] text-[28px] text-[#878B8A]">
            Customize your trivia game and invite players to join.
          </p>
        </div>
        <div className="mt-8 gradient-outline lg:w-[800px] w-[90%] p-[50px]">
          <h2 className="font-fredoka font-[500] text-[25px] gradient-text text-center">
            Game Details
          </h2>
          <div className="mt-10 flex flex-col gap-[30px]">
            <div className="flex flex-col gap-[8px]">
              <p className="text-[18px] font-poppins font-[500] text-[#fefefe]">
                Game Name
              </p>
              <input
                type="text"
                className="gradient-outline bg-transparent p-[20px] w-full font-poppins font-[400]"
            ...
            <div className="flex flex-col gap-[8px]">
              ...
              <select
                ...
                className="gradient-outline bg-transparent p-[20px] w-full font-poppins font-[400] text-[#9A9A9A] gragient-text"
              >
            ...
            <div className="flex justify-between">
              <div className="">
                ...
                <div className="w-full h-[50px] gradient-outline flex">
                  <button
                    onClick={() =>
            ...
            <button className="font-[700] rounded-[10px] font-nunito text-[18px] text-[#fefefe] bg-custom p-[20px]">Create Game</button>
          </div>
        </div>
      </div>
    </Layout>
